<nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
  <div class="container">
    <a class="navbar-brand" href="/"><img src="{{ asset('images/logo.png') }}" alt="NetsinCode"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <li class="nav-item dropdown {{request()->is('laporan') ? 'active' : ''}}">
        ...
        <li class="nav-item dropdown @@pages {{request()->is('') ? 'active' : ''}}">
          <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Program Kerja
        ...
        <li class="nav-item @@about {{request()->is('tentang') ? 'active' : ''}}">
          <a class="nav-link" href="/tentang">Tentang</a>
        </li>
        <li class="nav-item @@contact {{request()->is('saran') ? 'active' : ''}}">
          <a class="nav-link" href="/saran">Kotak Masukan & Saran</a>
        </li>
